...
void Intro() {
  ...
  sonicDraw();
    ...
    printf("          .______    __   _______ .__   __. ____    ____  _______ .__   __.  __    __   _______\n");
    sleep(0.5);
    ...
    printf("          |  |_)  | |  | |  |____ |  |\\   |    \\    /    |  |____ |  |\\   | |  `--'  | |  |____ \n");
    sleep(0.5);
    printf("          |______/  |__| |_______||__| \\__|     \\__/     |_______||__| \\__|  \\______/  |_______|\n");
    sleep(1);
    printf("\n\n");
    printf("                        _______       ___      .__   __.      _______.\n");
    sleep(0.5);
    printf("                          |       \\     /   \\     |  \\ |  |     /       |\n");
    sleep(0.5);
    printf("                          |  .--.  |   /  ^  \\    |   \\|  |    |   (----`\n");
    ...
    sleep(1);
    printf("\n\n");
    printf("______ ____    ____     _______  __    _______ .___________. __    __   _______ .______           _______.\n");
    sleep(0.5);
    printf(" /      |\\   \\  /   /    |   ____||  |  /  _____||           ||  |  |  | |   ____||   _  \\         /       |\n");
    sleep(0.5);
    ...
    printf("|  `----.    |  |        |  |     |  | |  |__| |     |  |     |  |  |  | |  |____ |  |\\  \\----..----)   |\n");
    sleep(0.5);
    printf(" \\______|    |__|        |__|     |__|  \\______|     |__|     |__|  |__| |_______|| _| `._____||_______/\n");
    sleep(2);
}
